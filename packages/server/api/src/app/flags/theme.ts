...
export const defaultTheme = generateTheme({
    primaryColor: '#6e41e2',
    websiteName: 'Prathams agentic world',
    fullLogoUrl: 'http://localhost:4200/mst_img.png',
    favIconUrl: 'http://localhost:4200/mst_img.png',
    logoIconUrl: 'http://localhost:4200/mst_img.png',
})
